...
public class Device extends IdEntity {
	...
	public void setCountry(String country) {
		this.country = (country != null && country.length() > 10) ? country.substring(0, 10) : country;
	}
	...
	public void setLanguage(String language) {
		this.language = (language != null && language.length() > 10) ? language.substring(0, 10) : language;
	}
